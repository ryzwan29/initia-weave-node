...
func TestHTTPClient_Get_Success(t *testing.T) {
	...
	_, err := httpClient.Get(mockServer.URL, "", nil, &result)
...
func TestHTTPClient_Get_Failure(t *testing.T) {
	...
	_, err := httpClient.Get(mockServer.URL, "", nil, nil)
...
func TestHTTPClient_DownloadFile_Success(t *testing.T) {
	...
	progress := int64(0)
	totalSize := int64(0)
	err = httpClient.DownloadFile(mockServer.URL, destFile.Name(), &progress, &totalSize)
...
func TestHTTPClient_DownloadFile_Failure(t *testing.T) {
	...
	err = httpClient.DownloadFile(mockServer.URL, destFile.Name(), nil, nil)
...
func TestHTTPClient_DownloadFile_InvalidURL(t *testing.T) {
	...
	err := httpClient.DownloadFile("http://invalid-url", "/path/to/file", nil, nil)
